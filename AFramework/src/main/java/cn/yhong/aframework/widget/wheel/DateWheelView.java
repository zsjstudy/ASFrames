package cn.yhong.aframework.widget.wheel;
...
import cn.yhong.aframework.widget.wheel.adapter.NumericWheelAdapter;
import cn.yhong.aframework.widget.wheel.listener.OnWheelChangedListener;

/**
 * 日期滚轮
 *
 * @deprecated Use {@link cn.yhong.aframework.dialog.DatePickerDialog} instead.
 *
 */
