...
import com.yhong.asframe.bean.UPMarqueeBean;
...
public class UPMarqueeViewActivity extends BaseActivity {
    ...
    private cn.yhong.aframework.widget.pager.UPMarqueeView mUPMarqueeView1;
    private cn.yhong.aframework.widget.pager.UPMarqueeView mUPMarqueeView2;

    @Override
    public void initView() {
        super.initView();
        mUPMarqueeView1 = (cn.yhong.aframework.widget.pager.UPMarqueeView) findViewById(R.id.mUPMarqueeView1);
        mUPMarqueeView2 = (cn.yhong.aframework.widget.pager.UPMarqueeView) findViewById(R.id.mUPMarqueeView2);
    }
